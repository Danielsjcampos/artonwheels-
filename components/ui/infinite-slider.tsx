...
type InfiniteSliderProps = {
  ...
  reverse?: boolean;
  className?: string;
  speedOnHover?: number; // Added to match hero snippet
  speed?: number; // Added to match hero snippet
};
...
export function InfiniteSlider({
  ...
  className,
  speed, // Destructured
  speedOnHover, // Destructured
}: InfiniteSliderProps) {
  // Use speed if duration is not provided or if speed is intended to be used as duration base
